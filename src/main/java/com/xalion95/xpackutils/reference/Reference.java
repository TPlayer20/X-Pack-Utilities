...
public class Reference {
    ...
    public static final String MOD_NAME = "X-Pack Utilities";
    ...
    public static final String UPDATE_HOSTNAME = "http://192.168.1.250";
    public static final String UPDATE_FILE_1_7_10 = "/version1.7.10.txt";
    public static final String UPDATE_FILE_JAVA = "/version.txt";
